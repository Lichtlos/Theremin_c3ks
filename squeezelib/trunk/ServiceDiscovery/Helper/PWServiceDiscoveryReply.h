...
typedef enum {
	PWServiceDiscoveryModeReplyName,
	PWServiceDiscoveryModeReplyCliPort,
	PWServiceDiscoveryModeUnknown
} PWServiceDiscoveryReplyMode;

@interface PWServiceDiscoveryReply : NSObject {
