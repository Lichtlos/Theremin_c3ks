...
- (SLCLIRequestFinishedAction) finishedWithResponse:(NSString *)response {
	...
	_currentPartialResult = [[[[PWResultTransformer resultTransformerForClass:[SLTitle class]] transformResults:infos] objectAtIndex:0] retain];
	[_currentPartialResult setPath:[_pathList objectAtIndex:_index - 1]];
